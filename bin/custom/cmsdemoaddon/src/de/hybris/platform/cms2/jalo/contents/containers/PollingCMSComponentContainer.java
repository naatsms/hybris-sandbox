...
public class PollingCMSComponentContainer extends GeneratedPollingCMSComponentContainer
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger( PollingCMSComponentContainer.class.getName() );
