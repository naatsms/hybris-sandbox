...
import ru.masterdata.constants.CmsdemoaddonConstants;



/**
 * This is the extension manager of the Cmsdemoaddon extension.
 */
public class CmsdemoaddonManager extends GeneratedCmsdemoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CmsdemoaddonManager.class.getName());
	 ...
	 */
	public static CmsdemoaddonManager getInstance()
	{
		return (CmsdemoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CmsdemoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CmsdemoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CmsdemoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CmsdemoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CmsdemoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
